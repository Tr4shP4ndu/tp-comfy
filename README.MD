...
python setup/add_model.py "https://example.com/model.safetensors" checkpoints

# With custom filename
python setup/add_model.py "https://example.com/model.safetensors" loras "my_lora.safetensors"
```
